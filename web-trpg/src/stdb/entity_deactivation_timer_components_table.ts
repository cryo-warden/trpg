...
import { TimerComponent } from "./timer_component_type";
...
export class EntityDeactivationTimerComponentsTableHandle {
  tableCache: TableCache<TimerComponent>;

  constructor(tableCache: TableCache<TimerComponent>) {
  ...
  entityId = {
    ...
    find: (col_val: bigint): TimerComponent | undefined => {
  ...
  onInsert = (cb: (ctx: EventContext, row: TimerComponent) => void) => {
    return this.tableCache.onInsert(cb);
  }

  removeOnInsert = (cb: (ctx: EventContext, row: TimerComponent) => void) => {
    return this.tableCache.removeOnInsert(cb);
  }

  onDelete = (cb: (ctx: EventContext, row: TimerComponent) => void) => {
    return this.tableCache.onDelete(cb);
  }

  removeOnDelete = (cb: (ctx: EventContext, row: TimerComponent) => void) => {
    return this.tableCache.removeOnDelete(cb);
  }

  // Updates are only defined for tables with primary keys.
  onUpdate = (cb: (ctx: EventContext, oldRow: TimerComponent, newRow: TimerComponent) => void) => {
    return this.tableCache.onUpdate(cb);
  }

  removeOnUpdate = (cb: (ctx: EventContext, onRow: TimerComponent, newRow: TimerComponent) => void) => {
