...
/**
 * Table handle for the table `appearance_features`.
 *
 * Obtain a handle from the [`appearanceFeatures`] property on [`RemoteTables`],
 * like `ctx.db.appearanceFeatures`.
 *
 * Users are encouraged not to explicitly reference this type,
 * but to directly chain method calls,
 * like `ctx.db.appearanceFeatures.on_insert(...)`.
 */
export class AppearanceFeaturesTableHandle {
